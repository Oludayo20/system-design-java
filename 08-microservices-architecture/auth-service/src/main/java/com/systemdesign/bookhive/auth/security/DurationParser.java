...
/**
 * Minimal parser for the duration string formats the source NestJS project accepts for
 * {@code JWT_EXPIRES_IN} (via the {@code ms} npm package), e.g. "1h", "30m", "7d", "3600s", or a
 * bare number of seconds. Covers the formats this project's .env.example actually uses.
 */
