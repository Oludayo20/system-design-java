...
/**
 * Central mapping from domain/validation exceptions to HTTP responses: every thrown exception
 * becomes a JSON body of the shape {@code { statusCode, message, error } }, matching the source
 * NestJS project's default exception filter output.
 */
